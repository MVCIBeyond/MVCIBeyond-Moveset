...
#define LOCTEXT_NAMESPACE "DuckEditor"
...
public:
	...
	virtual void StartupModule() override
	{
		...
		RegisterAssetTypeAction(AssetTools, MakeShareable(new FCharacterAsset_AssetTypeActions(DuckAssetCategoryBit)));
	}
