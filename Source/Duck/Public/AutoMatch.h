...
//CROSS-MODULE INCLUDE V2: -ModuleName=OnlineSubsystemDuck -ObjectName=EAutoMatchSelect -FallbackName=EAutoMatchSelect
//CROSS-MODULE INCLUDE V2: -ModuleName=OnlineSubsystemDuck -ObjectName=EAutoMatch_QoS -FallbackName=EAutoMatch_QoS
