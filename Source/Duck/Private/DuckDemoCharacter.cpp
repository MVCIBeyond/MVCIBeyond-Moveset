...
ADuckDemoCharacter::ADuckDemoCharacter(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->OriginalMeshComoonentForArrange = CreateDefaultSubobject<UDuckDemoSkeletalMeshComponent>(TEXT("OriginalMeshComponentArrange"));
